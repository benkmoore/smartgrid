...
include("FP_Setup.jl")
ext = pwd()
path = "$ext/FINLAND_ENERGY.csv" #"C:\\Users\\Ben\\Documents\\smartgridrl\\FINLAND_ENERGY.csv"
...
for loop = 1 : 1 : 1000
    for t = 1 : num_rows
        ...
        if t != num_rows #while t<num_rows
...
using JLD;
save("$ext/Q_QL.jld", "data", Q)
#save("C:\\Users\\Ben\\Documents\\smartgridrl\\Q_QL.jld", "data", Q)
#print(Q)
